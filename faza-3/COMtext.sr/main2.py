...
if __name__ == "__main__":
    ...
    default_dir = default_dir = os.path.normpath(os.path.join(script_dir, "..", "..", "faza-2", "anotirani_tekstovi"))
    files = collect_from_dir(default_dir)
    for filename in files:
        if filename.endswith(".conllu"):
            file_input_path = os.path.join(default_dir, filename)
    ...
    "B-COM", "I-COM", "B-ADR", "I-ADR", "O", "B-REF", "B-LAW", "I-LAW", 
    "B-PER", "I-PER", "B-TOP", "I-TOP", "I-REF", "B-MONEY", "I-MONEY", 
    "B-DATE", "I-DATE", "B-INST", "I-INST", "B-IDCOM", "B-IDOTH", 
    "B-NUMDOC", "B-MISC", "I-MISC", "B-CONTACT", "B-IDPER", "B-NUMPLOT", 
    "B-IDTAX", "B-COURT", "I-COURT", "B-NUMCAR", "B-ORGOTH", "I-ORGOTH", 
    "I-NUMCAR", "B-NUMACC"
]
    model_args.max_seq_length = 400
    model = NERModel(
        "electra", "ICEF-NLP/bcms-bertic-comtext-sr-legal-ner-ekavica", args=model_args, use_cuda=False
    )
    ...
    for sentence in predictions:
        for word in sentence:
            ...
            y_pred.append(map_labels(label))
